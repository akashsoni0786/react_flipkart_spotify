...
export const LeagalHeadings = () => {
  return (
    <div style={{display:"flex",flexDirection: "row", justifyContent:"space-between",width:"180px",marginLeft:"4%",fontSize:".7vw",cursor: 'pointer'}}>
...
export const Columns = () => {
  return (
    <div style={{textAlign:"left",flexDirection: "column",display:"flex",justifyContent:"space-between",height:"80px",marginLeft:"30px"}}>
        <span style={{fontSize:"10px",cursor: 'pointer'}}>Company</span>
        <span style={{fontSize:"1.4vw",cursor: 'pointer'}}>About</span>
        <span style={{fontSize:"1.4vw",cursor: 'pointer'}}>Jobs</span>
        <span style={{fontSize:"1.4vw",cursor: 'pointer'}}>For Records</span>
        <span style={{fontSize:"1.4vw",cursor: 'pointer'}}>Jobs</span>
    </div>
  )
}
...
export const Logos= () => {
  return (
    <div style={{textAlign:"left",flexDirection: "row",display:"flex",top:"0",flexWrap:"wrap"}}>
        <img alt='' style={{width:"2vw",height:"1.5vw",margin:"1.2vw",cursor: 'pointer'}} src='https://cdn-icons-png.flaticon.com/512/5968/5968764.png'/>
        <img alt='' style={{cursor: 'pointer',width:"2vw",height:"1.5vw",margin:"1.2vw"}} src='https://cdn-icons-png.flaticon.com/512/5968/5968764.png'/>
        <img alt='' style={{cursor: 'pointer',width:"2vw",height:"1.5vw",margin:"1.2vw"}} src='https://cdn-icons-png.flaticon.com/512/5968/5968764.png'/>
